...
<head>
    <meta charset="utf-8">
    <title>As-Sakiinah Store @yield('title')</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="Free HTML Templates" name="keywords">
    <meta content="Free HTML Templates" name="description">

    <!-- Favicon -->
    <link href="logotoko.png" rel="icon">
        ...
        <div class="row gx-5 py-3 align-items-center">
            <div class="col-lg-3">
                <div class="d-flex align-items-center justify-content-start">
                    <a href="/">
                        <img src="logotoko.png" alt="" style="width: 100px">
                    </a>
...
{{-- @endsection --}}
    ...
    <div class="container-fluid bg-dark text-white py-4">
        <div class="container text-center">
            <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="https://assakiinahstore.com">2022 As-SakiinahStore</a>. All Rights Reserved.</p>
        </div>
    </div>
    <!-- Footer End -->
